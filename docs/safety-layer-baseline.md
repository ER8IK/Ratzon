...
- `bot/protocols/router.py` already isolated quote execution behind a protocol router, with Jupiter live and mapped route adapters listed.
...
- Cross-chain provider abstraction with a SimpleSwap route adapter alongside Jupiter.
